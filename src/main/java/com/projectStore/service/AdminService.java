...
// @Transactional
// public User createAdmin(AdminCreationDTO dto, String ipAddress, String
// creatorUsername) {
// // Buscamos el super administrador (quien crea el nuevo admin)
// User superAdmin = userService.findByEmail(creatorUsername);
...
// User admin = new User();
// admin.setEmail(dto.getEmail());
// admin.setPassword(dto.getPassword()); // Nota: se debería encriptar la
// contraseña
...
// // Asignar tiendas al administrador y registrar auditoría para cada una
// if (dto.getAssignedStoreIds() != null &&
// !dto.getAssignedStoreIds().isEmpty()) {
// for (Long storeId : dto.getAssignedStoreIds()) {
...
// auditService.registerAudit(
// ipAddress,
// "Tienda asignada a administrador: " + store.getName() + " -> " +
// admin.getEmail(),
