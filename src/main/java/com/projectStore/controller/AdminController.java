...
// /**
// * Obtiene las tiendas creadas por el administrador actual usando Firebase
// Authentication
// */
// @GetMapping("/my-stores")
// public ResponseEntity<List<StoreDTO>>
// getMyStores(@RequestHeader("Authorization") String authorizationHeader) {
// try {
...
// */
// @PostMapping("/stores")
// public ResponseEntity<StoreDTO> createStore(@RequestBody StoreCreationDTO
// storeDTO,
...
// // Buscar el usuario admin en la base de datos usando el email obtenido de
// Firebase
...
// throw new RuntimeException("ID de tienda no coincide con el del cuerpo de la
// solicitud");
// }
...
// // Llamar al service para eliminar la tienda usando el ID del admin
// autenticado
